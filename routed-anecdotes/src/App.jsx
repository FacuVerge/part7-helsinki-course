...
const CreateNew = ({addNew, setNotification}) => {
  ...
  const {reset: resetContent, ...inputContentProps} = content;
  const {reset: resetAuthor, ...inputAuthorProps} = author;
  const {reset: resetInfo, ...inputInfoProps} = info;
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          content
          <input {...inputContentProps} />
        </div>
        <div>
          author
          <input {...inputAuthorProps} />
        </div>
        <div>
          url for more info
          <input {...inputInfoProps} />
        </div>
